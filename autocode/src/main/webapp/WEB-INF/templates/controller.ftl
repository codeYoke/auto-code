...
public Map
<String, Object> list(@ModelAttribute ${entityName} ${entityName?uncap_first}){
...
public Map
<String, Object> add(@ModelAttribute ${entityName} ${entityName?uncap_first}) {
...
public Map
<String, Object> update(@ModelAttribute ${entityName} ${entityName?uncap_first}) {
...
public Map
<String, Object> delete(@ModelAttribute ${entityName} ${entityName?uncap_first}) {
...
public Map
<String, Object> exist(@ModelAttribute ${entityName} ${entityName?uncap_first}) {
